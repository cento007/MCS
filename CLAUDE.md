...
**Teams and workflows are not built.** `agent_teams` is still a skeleton, `agent_team_members` does not exist, and `agent.assigned` / `agent.execution_*` remain reserved and unproduced.
