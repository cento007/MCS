 ...
 *
 * It lives in `@mc/shared` rather than in the Backend because both sides of Phase 3 need it and
 * F2.2 forbids a worker importing Backend modules: indexing is Sync Worker work, retrieval is
 * Backend work, and they must agree byte-for-byte on what a stored point means.
 */
